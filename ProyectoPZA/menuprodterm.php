...
<head>
    ...
    <title>Menú productos terminados</title>
</head>
<body>
            ...
            <!--<div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="prodtermrRS.php" class="btn btn-primary">Acceder</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">Modificar la cantidad de productos que hay en inventario</p>
                  <a href="prodtermU.php" class="btn btn-primary">Acceder</a> 
                </div>
              </div>
            </div>-->
            <div class="col-sm-6">
            ...
            <!--<div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">Eliminar productos del inventario</p>
                  <a href="prodtermD.php" class="btn btn-primary">Acceder</a>
                </div>
              </div>
            </div>-->
